...
namespace app.Reports
{
    public partial class frptKetQuaCaNam_MonHoc : Office2007Form
    {
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            IList<KQCaNamMonHocInfo> KQCNMH =
                KQCaNamMonHocCtrl.LayDsKQCaNamMonHoc(cmbLop.SelectedValue.ToString(), cmbMonHoc.SelectedValue.ToString(),cmbNamHoc.SelectedValue.ToString());
            this.bSKQCNMH.DataSource = KQCNMH;
